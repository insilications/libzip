...
Version  : 1.7.3
Release  : 18
URL      : file:///insilications/build/clearlinux/packages/libzip/libzip-v1.7.3.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/libzip/libzip-v1.7.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599675335
mkdir -p clr-build
pushd clr-build
